...
void AWorldItem::AuthorityTriggerPrimaryAction_Implementation(APlayerCharacter* User)
{
...
void AWorldItem::AuthorityTriggerSecondaryAction_Implementation(APlayerCharacter* User)
{
